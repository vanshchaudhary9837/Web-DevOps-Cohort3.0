...
greetUser(user); // Hello Vansh, You are 21 years old.
...
greet(user1); // Hi Mr Vansh, your age is 21
...
greet(user2); // Hi Mr Vansh, your age is 21 and you are eligible to vote